...
class RECT(pya.PCellDeclarationHelper):
    ...
    def coerce_parameters_impl(self):         
        ...
        self.modify_lt = 0 if self.modify_lt <= 0 else self.modify_lt
        self.modify_lb = 0 if self.modify_lb <= 0 else self.modify_lb
        self.modify_rt = 0 if self.modify_rt <= 0 else self.modify_rt
        self.modify_rb = 0 if self.modify_rb <= 0 else self.modify_rb
